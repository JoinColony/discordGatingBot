_discord-gating-bot() {
    ...
    case "${cmd}" in
        discord__gating__bot)
            ...
            return 0
            ;;
        discord__gating__bot__config)
            opts="-h -v -q --help --verbose --quiet show template help"
            ...
            return 0
            ;;
        discord__gating__bot__config__help)
            ...
            return 0
            ;;
        discord__gating__bot__config__show)
            ...
            return 0
            ;;
        discord__gating__bot__config__template)
            opts="-h -v -q --help --verbose --quiet"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        discord__gating__bot__discord__delete__help)
            ...
            return 0
            ;;
        discord__gating__bot__discord__help)
            opts="-v -q --verbose --quiet <SUBCOMMAND>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
...
complete -F _discord-gating-bot -o bashdefault -o default discord-gating-bot
